    ...
    <Page showConnectButton={true} showNav={false} showAppFooter={false} showAppHeader={false}>
      <div className={`${sidebarStateActive ? 'sidebarActive' : 'sidebarSmall'} min-h-screen gameBGImage`}>
        <div className="mt-24 mx-[4.5rem]">
          <h4 className="text-brand-green mb-32">Coin Flip</h4>
          <section
            className={`${
          ...
          >
            ...
            <div className="basis-3/4">
              <p className="title28">
                <span className="text-[48px] font-thin text-brand-green">Coin Flip</span> takes your bets and rewards up
                or down. Dive into the world of digital assets and test your intuition - will your chosen token rise
                (&apos;Up&apos;) or fall (&apos;Down&apos;) in value? It&apos;s an engaging way to explore the dynamic
                crypto market without risking real money. Make your predictions and see if you&apos;ve got what it takes
                to anticipate the crypto rollercoaster. Have fun while honing your crypto-savvy skills in the Crypto
          ...
          <div className="flex justify-center mx-auto max-w-[245px]">
            <ActionButtonItem text="Play Coin Flip" color="blue" link="coinflip/play" />
          </div>
        </div>
      </div>
    </Page>
