    ...
    <Page showConnectButton={true} showNav={false} showAppFooter={false} showAppHeader={false}>
      ...
      >
        <div className="mt-24 mx-[4.5rem]">
          <h4 className="text-brand-green mb-32">Slots</h4>
          <section
            className={`${
          ...
          >
            ...
            <div className="basis-3/4">
              <p className="title28">
                <span className="text-[48px] font-thin text-brand-green">Slots</span> takes your bets and rewards up or
                down. Dive into the world of digital assets and test your intuition - will your chosen token rise
          ...
          <div className="flex justify-center mx-auto max-w-[245px]">
            <ActionButtonItem text="Play Slots" color="blue" link="slots/play" />
          </div>
        </div>
      </div>
    </Page>
